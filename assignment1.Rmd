...
1. Question: How many observations are in the data set? What unit of analysis does each observation represent?
    1. Answer: There are **`r observations`** observations in the data set. Each observation represents an individual within the study. This includes the respondents and non-respondents.
